...
Critical issue:
- drawing a filled, anti-aliased circle to the left or right of the image (not within the image at all) would cause a buffer overflow. [#128208](https://github.com/tonycoz/imager/issues/128208) General changes: 
...
- most numeric parameters to the XS implementation now throw an exception if supplied an unoverloaded reference. [#128208](https://github.com/tonycoz/imager/issues/128208) Coverity finally finished a build[1], fixed several of the problems found. Coverity went down before I could finish working through them. High severity: 
